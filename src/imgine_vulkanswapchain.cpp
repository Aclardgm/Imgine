...
{
    Imgine_QueueFamilyIndices indices;
...
{
    Imgine_SwapChainSupportDetails details;
...
VkSurfaceFormatKHR Imgine_SwapChain::chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& availableFormats)
{
