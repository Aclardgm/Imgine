...
SwapChainSupportDetails Imgine_Vulkan::querySwapChainSupport(VkPhysicalDevice device)
{
    {
...
void Imgine_Vulkan::createSwapChain()
{
    {
...
void Imgine_Vulkan::createSurface(GLFWwindow* window)
{
    {
...
QueueFamilyIndices Imgine_Vulkan::findQueueFamilies(VkPhysicalDevice device)
{
    {
