...
void Imgine_VulkanPipeline::createGraphicsPipeline(Imgine_VulkanLayout* layout) {
    ...
    // Assign shader to specific stage
    ...
    auto bindingDescription = Imgine_Vertex::getBindingDescription();
    auto attributeDescriptions = Imgine_Vertex::getAttributeDescriptions();
...
VkShaderModule Imgine_VulkanPipeline::createShaderModule(const std::vector<char>& code)
{
