#pragma once
#ifndef ImGINE_INTTYPES
#define ImGINE_INTTYPES

/// from https://github.com/hlavacs/ViennaGameJobSystem
...
*
* T...the integer type
* P...phantom type as unique ID -> allow for differentiation between multiple template instance with same definition but from wich we want different instances to separate statics
