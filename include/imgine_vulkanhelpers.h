#pragma once
#ifndef ImGINE_VULKANHELPERS
#define ImGINE_VULKANHELPERS
...
#ifdef _DEBUG
    static inline void check_vk_result(VkResult err,std::string mess)
    {
        if (err == 0)
            return;
        std::string str = "[vulkan] Error: VkResult = " + err;
        str += "\n" + mess + "\n";
